...
// Apex
import getAllDocuments from '@salesforce/apex/LWC03_DocumentToUpload_cTin.getAllDocuments';
import replaceDocument from '@salesforce/apex/LWC03_DocumentToUpload_cTin.replaceDocument';
import deleteDocument from '@salesforce/apex/LWC03_DocumentToUpload_cTin.deleteDocument';
import getDocumentType from '@salesforce/apex/LWC03_DocumentToUpload_cTin.getDocumentType';
import addDocuments from '@salesforce/apex/LWC03_DocumentToUpload_cTin.addDocuments';
//import updateDocument from '@salesforce/apex/LWC03_DocumentToUpload_cTin.updateDocument';
// Resource
...
const COLUMNS1 = [
    ...
    {label:LWC03_SendForEsignature, fieldName:'sendForEsignature', type: 'boolean', initialWidth: 150, cellAttributes: {alignment: 'center'}},
...
export default class LWC_UploadedDocument_cTin extends NavigationMixin(LightningElement) {
    subscription = null;
    @api recordId;
    @api isLoading = false;
    @track user;
    ...
    handleDocumentType(event){
        ...
        if(typeof this.selectedDocType == 'undefined' || this.selectedDocType == null){
